sap.ui.define([
	...
	return BaseController.extend("zsample2.controller.Master", {
		...
		onInit : function () {
			...
			this._oGroupFunctions = {
				connid : function(oContext) {
					var iNumber = oContext.getProperty('connid'),
						key, text;
					if (iNumber <= 2000) {
						key = "LE20";
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this._pViewSettingsDialog) {
				this._pViewSettingsDialog = Fragment.load({
					...
					name: "zsample2.view.ViewSettingsDialog",
					controller: this
		...
		onConfirmViewSettingsDialog : function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
					case "Filter1" :
						aFilters.push(new Filter("connid", FilterOperator.LE, 2000));
						break;
					case "Filter2" :
						aFilters.push(new Filter("connid", FilterOperator.GT, 2000));
						break;
					default :
						break;
				}
